...
class Graph
{
    ...
    public:
        ...
        auto get_seq_nhood_exact(unsigned a, const Sequence & s) const -> const std::vector<unsigned>;
        auto get_seq_nhood_overlap(unsigned a, const Sequence & s) const -> const std::vector<unsigned>;
